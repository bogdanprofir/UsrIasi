...
Pierderile transformate în profit!</h2>
      ...
      <div className="prose prose-lg font-eleron text-l">
        <p className="text-justify indent-5">Subiectul acțiunii noastre este proiectul termoficării <strong>verzi și ieftine</strong> propusă de senatorul USR Marius Bodea, un proiect care a fost înțeles ușor de către toți cei cu care am interacționat, indiferent de vârstă.</p>
        <p className="text-justify indent-5">Un proiect integrat, bazat pe <strong>surse regenerabile de energie</strong>, care ar putea <span className="underline italic">rezolva pe termen nelimitat problema asigurării încălzirii în sistem centralizat pe timpul iernii la Iași</span>, producerea de gaz și energie electrică pe tot parcursul anului care să fie valorificată în sistemul național.</p>
        <p className="text-justify indent-5">Cu o investiție totală de 30-35 de milioane de euro, finanțabilă din <strong>fonduri nerambursabile prin programul RePowerEU și PNRR</strong> și implementată pe parcursul a trei ani, Iașul ar putea să devină furnizor de energie verde, în loc să achiziționeze la prețuri exorbitante sute de mii de tone cărbune pentru care plătește 10 milioane de euro anual doar pentru efectul poluator și doar pentru a încălzi 15% din locuințele din municipiul Iași.</p>
