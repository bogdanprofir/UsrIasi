...
import USRBreakImg from '../assets/break2.jpg'; 
import { Helmet } from 'react-helmet'

function USRBreakEvent() {
  return (
    <div className="max-w-3xl mx-auto flex text-[#002A59] flex-col items-center justify-center pt-20 bg-white bg-opacity-90">
      <Helmet>
        <title>B.R.E.A.K. Eveniment USR Iași</title>
      </Helmet>
